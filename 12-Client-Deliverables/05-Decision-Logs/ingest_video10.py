"""
Ingest video 10 (wk1s0wE5Gww) - Unveiling Power Query AI Web Import Enhancements
"""
...
video_id = 'wk1s0wE5Gww'
title = "Unveiling Power Query AI Web Import Enhancements"
channel = 'MyOnlineTrainingHub'
duration = '8:59'
topics = ['Power Query', 'AI Web Import', 'Web Scraping', 'Data Import', 'Web Connector', 'Custom Functions', 'Table Detection', 'Microsoft 365']

transcript = """0:00 Power Query in Excel can now use AI to see what you see on a web page and enable you
...
# Chunk and ingest (transcript file already saved)
...
print('Note: Transcript file was already saved previously')
