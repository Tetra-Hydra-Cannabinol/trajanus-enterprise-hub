...
API_KEYS = [
    "AIzaSyDmHDqiRwL9o44SJBtOxi2i7Y0aW-dbiqY",  # Key 1 - FRESH NEW PROJECT
    "AIzaSyBl_lWBv86KeH4HnFaV0MoptSxMLaYgrSI",  # Key 2
    "AIzaSyAY8QD37iUhiccdfmXqGcLdphJCMV_cr7I",  # Key 3
    "AIzaSyBH06ztWeFjGYQLsT9URPSttTj8FqD3Wps",  # Key 4
    "AIzaSyAzNEedSAv-WgTW6u5o_HhHKK6ZK-H8VS4",  # Key 5
    "AIzaSyBzoOMyeXxS-wu_VVf_N44i0rzdlbhHuI8",  # Key 6
    "AIzaSyC9UM5IFzu8TAuEk6ExZO2EEEJo2CC1sBc",  # Key 7
    "AIzaSyAIQXiivQh82BhdKTDHyr212Te8C9_vhhw",  # Key 8
    "AIzaSyBPoG5wTkf0rDahD83x7mjW5u_hAxKhx28",  # Key 9
    "AIzaSyBF6aAzFmU7GcBCKQDsyD8G4wSQ1xO0jsA",  # Key 10
    "AIzaSyD1wlaiHX9GueAevuoG8KvZkFGED9OD2xk",  # Key 11
]
